({
    doInit: function(component, event, helper) {
        try{
            ...
            var sortByOptions = component.get('v.sortByOptions');
            if (!(fieldset instanceof Array) || fieldset.length == 0 ) {
            ...
            if ( (!(sortByOptions instanceof Array) || sortByOptions.length == 0 ) && sortByFields != '' && sortByFields != null ) {
